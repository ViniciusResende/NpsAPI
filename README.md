...
<p align= "center">:man_astronaut: An repository visioning the development of an API using NodeJs who sends satisfaction surveys in the users :man_astronaut: emails and than calculate the NPS from a certain company. </p>
